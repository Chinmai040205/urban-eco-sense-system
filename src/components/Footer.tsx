      ...
      <div className="container mx-auto py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-600 text-sm">
              Revolutionizing waste management with smart IoT technology for cleaner and more sustainable cities.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Smart Bins</a></li>
              <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Route Optimization</a></li>
              <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Data Analytics</a></li>
              <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Waste Forecasting</a></li>
              <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">City Integration</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">GDPR Compliance</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <p className="text-center text-gray-500 text-sm">
            © 2025 EcoSense. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
